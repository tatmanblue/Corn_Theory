...
{
    /// <summary>
    /// this class replaces  UnityStandardAssets.Characters.ThirdPerson.ThirdPersonUserControl
    /// </summary>
    [RequireComponent(typeof(CornTheoryThirdPersonCharactor))]
    public class CornTheoryThirdPersonUserControl : MonoBehaviour
    {
        private CornTheoryThirdPersonCharactor character;   // A reference to the ThirdPersonCharacter on the object
        ...
        private void Start()
        {
            ...
            character = GetComponent<CornTheoryThirdPersonCharactor>();
        }
