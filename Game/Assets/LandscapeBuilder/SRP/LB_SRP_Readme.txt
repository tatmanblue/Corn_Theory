Scriptable Render Pipeline assets in LB require Unity 2018.4.3f1 or newer.
...
2. If using LWRP, from package manager, import Lightweight Render Pipeline 4.0.1 or newer (U2018.4 or newer is required)
3. If using HDRP, from package manager, import High Definition Render Pipeline 4.9.0 or newer (U2018.4 or newer is required)  
...
d) HDRP 7.3.1 requires U2019.4.1 or newer
e) The demo scenes are designed for the built-in RP. Vegetation and water will not render or will look incorrect.
